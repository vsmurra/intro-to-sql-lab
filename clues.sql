...
WHERE countries.name = 'San Marino' AND isofficial = 'true';
...
FROM cities
WHERE countrycode = (
  SELECT code FROM countries WHERE name = 'Italy'
)
AND name != 'Italy';
...
WHERE c.name LIKE 'Rom%' AND c.name != 'Rome' AND co.region = 'South America';
